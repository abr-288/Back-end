            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-content mb-4">
                        ...
                        <p class="mb-4">At DreamsTour, we believe that travel should be simple, seamless, and tailored to
                            your needs. Whether you're dreaming of an exotic beach getaway, a cultural city tour, or a
                            luxury cruise, we are here to turn your travel dreams
                            into reality.​</p>
                ...
                <div class="col-lg-3">
                    <div class="choose-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="fs-16 text-gray-6">We work with trusted travel partners to bring you the best deals,
                                whether you're booking a flight, hotel, or car rental.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <div class="choose-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="fs-16 text-gray-6">Whether you're traveling for business, family vacations, or a solo
                                adventure, we provide options that suit every needs</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-7 d-flex justify-content-center">
                        <div class="header-section text-center">
                            ...
                            <p class="fs-16 text-gray-6">We’re a team of explorers, innovators, and customer-focused
                                professionals who are passionate about making travel easy and accessible for everyone.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('build/img/users/user-17.jpg') }}" alt="Img"
                                        class="img-fluid">
                                </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('build/img/users/user-20.jpg') }}" alt="Img"
                                        class="img-fluid">
                                </div>
                                <div class="team-overlay">
                                    <div class="bg-white py-2 px-3 rounded-pill  text-center">
            ...
            <div class="owl-carousel testimonial-slider">
                ...
                <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Dream Tours is the only way to go. We had the time of our life on our trip to the
                            Ark. The customer service was wonderful & the staff was very helpful.</p>
