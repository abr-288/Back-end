                ...
                <div class="row align-items-center">
                    <div class="col-md-12 mx-auto wow fadeInUp" data-wow-delay="0.3s">
                        <div class="banner-content mx-auto">
                            <h1 class="text-white display-5 mb-2">Se rapprocher du rêve : <span>L'essentiel</span> L'essentiel est à portée de main</h1>
                            <h6 class="text-light mx-auto">Votre destination ultime pour tout ce qui peut vous aider à célébrer et à vous souvenir de votre expérience.</h6>
                        </div>
